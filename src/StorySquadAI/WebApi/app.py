...
from src.StorySquadAI.WebApi.bot_personalities import *
...
def setup():
    ...
    if "Enclosure to handle personality enumeration":
        ...
        bot_personalities_enum_file_py = os.path.join(web_api_dir, "bot_personalities.py")
...
bots = {}
setup()
from src.StorySquadAI.WebApi.bot_personalities import BotName
