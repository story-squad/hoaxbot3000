...
class StorySquadBot:
    def __init__(self, personality, llmwrapper_for_bot: LLMWrapper, data_dir: str = "data",
        ...
        self.llm_pre_filters = [filters.ModerateFilter(name='moderate')]
        self.llm_post_filters = [filters.MinimumLengthFilter(name="length"),
                                 filters.ModerateFilter(name='moderate'),
                                 filters.FactualFilter(name='factual')]
